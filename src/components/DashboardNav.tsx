...
import { CalendarDays, CalendarRange, LayoutDashboard, Scissors, Users, Contact, Settings } from "lucide-react";
import { Logo } from "./Logo";
import { logoutAction } from "@/actions/auth";
const items=[["/dashboard",LayoutDashboard,"Overview"],["/dashboard/calendar",CalendarRange,"Calendar"],["/dashboard/bookings",CalendarDays,"Bookings"],["/dashboard/services",Scissors,"Services"],["/dashboard/staff",Users,"Staff"],["/dashboard/customers",Contact,"Customers"],["/dashboard/settings",Settings,"Settings"]] as const;
